#!/bin/bash
# Left Projector Power Off Automation Launcher
...
# Display banner
echo "=================================================="
echo "  Left Projector Power Off Automation"
echo "  Target: http://192.168.1.21/PJControl.html"
echo "=================================================="
echo ""
...
# Run the automation
echo "Starting Left Projector Power Off automation..."
echo ""
"$PYTHON_CMD" examples/automate_left_projector_off.py
