"""
Left Projector Power On Automation
...
class LeftProjectorPowerOnAutomation:
    """
    Automation for Left Projector Power On button
    URL: http://192.168.1.21/PJControl.html
    """
    
    def __init__(self):
        """Initialize the left projector power on automation."""
...
def main():
    """Main function to run the left projector power on automation."""
    # Ensure necessary directories exist
    Config.ensure_directories()
    
    print("="*50)
    print("Left Projector Power On Automation")
    print("="*50)
    print("Target: http://192.168.1.21/PJControl.html")
    print("="*50)
    
    # Create and run automation
    automation = LeftProjectorPowerOnAutomation()
    automation.run()
