#!/bin/bash
# Both Projectors Power Off Automation Launcher
...
# Display banner
echo "============================================================"
echo "  Both Projectors Power Off Automation"
...
# Run the automation
echo "Starting Both Projectors Power Off automation..."
echo "This will control both projectors simultaneously..."
echo ""
"$PYTHON_CMD" examples/automate_both_projectors_off.py
